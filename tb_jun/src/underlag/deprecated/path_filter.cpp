...
void update_and_publish_path(){
  ...
  pathout_floor   = constrain_path_vstd(path_candidates_floor,path_visited,4,true);
  ////////*******************//////////////////////
  pathout_0 = constrain_path_xyz(path_candidates,20,20,3,3);
  if(pathout_0.poses.size() == 0){
    pathout_0 = constrain_path_xyz(path_candidates,20,20,20,20);
  }
  if(pathout_0.poses.size() == 0){
