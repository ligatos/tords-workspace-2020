...
nav_msgs::Path path_vlp_full,path_candidates_sides,path_candidates,path_visited,path_candidates2d,path_floor,path_vlp;
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher pub_poly 			= nh.advertise<geometry_msgs::PolygonStamped>("/tb_path/vlp_poly",100);
	...
	ros::Publisher pub_path_vlp_full = nh.advertise<nav_msgs::Path>("/tb_path/vlp_obstacles",100);
